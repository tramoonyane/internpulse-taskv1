...
const { handler } = require('../netlify/functions/getUserByName');
...
describe('Netlify Function: Get User By Name', () => {
    ...
    it('should return 404 for non-existing user', async () => {
        const event = {
            httpMethod: 'GET',
            queryStringParameters: { name: 'Non Existent User' },
        };
